...
router.get("/level/:levelId/count", politicianController.getPoliticiansCountByLevel);
router.get("/:id/roles", politicianController.getPoliticianRoles);
router.get("/:id/party", politicianController.getPoliticianParty);
